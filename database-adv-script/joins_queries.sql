SELECT u.user_id, u.first_name, u.last_name, u.email, u.phone_number, b.booking_id, b.total_price, b.status from users as u join booking as b on b.user_id = u.id
